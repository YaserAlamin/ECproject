...
public class Main {
	...
	public static void main(String[] args) {
		...
		int N = 100;					// N - number of elements (must be a multiple of s)
		int l = 15;						// l - lenght of the string representation
		int s = 2;						// s - tournament size
		double pm = 0.2;				// Pm - probability of mutation
		double pc = 0.7;				// Pc - probability of crossover
		...
		GeneExpressionAlghorithm.gep(SEL_method, N, l, s, pm, pc, r, g);
	}
}
/*
class Experiments{
